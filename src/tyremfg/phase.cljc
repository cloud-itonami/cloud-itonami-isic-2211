(ns tyremfg.phase
  "Phase 0->3 staged rollout for the rubber-tyre-and-tube plant-
  ...
  consequence (a building/curing/vulcanization-line maintenance window
  means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `tyremfg.governor`'s `line-actuate-blocked-violations` HARD-blocks
...
(defn verdict->disposition
  "Map a Tyre Plant Operations Governor verdict to a base disposition
