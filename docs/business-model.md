# Business Model: Manufacture of rubber tyres and tubes
...
## Classification
- Repository: `cloud-itonami-isic-2211` ([github.com/cloud-itonami/cloud-itonami-isic-2211](https://github.com/cloud-itonami/cloud-itonami-isic-2211))
- ISIC Rev.5: `2211` — Manufacture of rubber tyres and tubes
- Domain: `:rubber-tyre/manufacturing`
- Social impact: :worker-safety :road-safety :materials-safety
- Actor: `:tyre-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :rubber-tyre/manufacturing — who wants
...
One managed tenant (:rubber-tyre/manufacturing):
...
- Do not bypass the `:tyre-plant-operations-governor` for production decisions.
