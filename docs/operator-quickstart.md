# Operator Quickstart — Manufacture of rubber tyres and tubes

Shortest path from clone to a verified local dry-run for **ISIC 2211** (`cloud-itonami-isic-2211`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2211.git
cd cloud-itonami-isic-2211
```
...
- Blueprint governor key: `tyre-plant-operations-governor`
- Likely source path: `tyremfg.governor.cljc`
